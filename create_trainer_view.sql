...
select concat(tcenter.id,trainer.id) as _id, DATE_FORMAT(GREATEST( IFNULL(trainer.modified_date,'1970-01-01 12:00:00'),'1970-01-01 12:00:00'), '%Y-%m-%d %T') AS modification_time,
